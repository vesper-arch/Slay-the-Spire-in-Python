...
relics: dict[str: dict] = {
    ...
    # Common Relics
    'Akabeko': {'Name': 'Akabeko', 'Class': 'Any', 'Rarity': 'Common', 'Vigor': 8, 'Info': 'Your first <attack>Attack</attack> each combat deals 8 additional damage.', 'Flavor': 'Muuu~'},
    ...
    'Nunchaku': {'Name': 'Nunchaku', 'Class': 'Any', 'Rarity': 'Common', 'Energy': 1, 'Info': 'Every time you play 10 <attack>Attacks</attack, gain 1 <keyword>Energy</keyword>', 'Flavor': 'A good training tool. Inproves the posture and agility of the user.'},
    ...
    'Omamori': {'Name': 'Omamori', 'Class': 'Any', 'Rarity': 'Common', 'Curses': 2, 'Info': 'Negate the next 2 <curse>Curses</curse> you obtain.', 'Flavor': 'A common charm for staving off vile spirits. This one seems to possess a spark of divine energy.'},
    ...
    'Pen Nib': {'Name': 'Pen Nib', 'Class': 'Any', 'Rarity': 'Common', 'Attacks': 10, 'Info': 'Every 10th <attack>Attack</attack> you play deals double damage.', 'Flavor': 'Holding the nib, you can see everyone ever slain by a previous owner of the pen. A violent history.'},
    ...
    'The Boot': {'Name': 'The Boot', 'Class': 'Any', 'Rarity': 'Common', 'Info': 'When you would deal 4 or less unblocked <attack>Attack</attack> damage, increase it to 5.', 'Flavor': 'When wound up, the boot grows larger in size.'},
    ...
    # Uncommon relics
    'Blue Candle': {'Name': 'Blue Candle', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': '<curse>Curse</curse> cards can now be played. Playing a <curse>Curse</curse> will make you lose 1 HP and <keyword>Exhaust</keyword> the card.', 'Flavor': 'The flame ignites when shrouded in darkness.'},
    'Bottled Flame': {'Name': 'Bottled Flame', 'Class': 'Any', 'Rarity': 'Uncommon', 'Card Type': 'Attack', 'Info': 'Upon pickup, choose an <attack>Attack</attack> card. At the start of your turn, this card will be in your hand.', 'Flavor': 'Inside the bottle resides a flame which eternally burns.'},
    'Bottled Lightning': {'Name': 'Bottled Lightning', 'Class': 'Any', 'Rarity': 'Uncommon', 'Card Type': 'Skill', 'Info': 'Upon pickup, choose an <skill>Skill</skill> card. At the start of your turn, this card will be in your hand.', 'Flavor': 'Peering into the swirling maelstrom, you see a part of yourself staring back.'},
    'Bottled Tornado': {'Name': 'Bottled Tornado', 'Class': 'Any', 'Rarity': 'Uncommon', 'Card Type': 'Power', 'Info': 'Upon pickup, choose an <power>Power</power> card. At the start of your turn, this card will be in your hand.', 'Flavor': 'The bottle gently hums and whirs.'},
    'Darkstone Periapt': {'Name': 'Darkstone Periapt', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Whenever you obtain a <curse>Curse</curse>, raise your Max HP by 6.', 'Flavor': 'The stone draws power from dark energy, converting it into vitality for the user.'},
    ...
    'Molten Egg': {'Name': 'Molten Egg', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Whenever you add an <attack>Attack</attack> card to your deck, it is <keyword>Upgraded</keyword>. ', 'Flavor': 'The egg of a Pheonix. It glows red hot with a simmering lava.'},
    'Toxic Egg': {'Name': 'Toxic Egg', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Whenever you add a <skill>Skill</skill> card to your deck, it is <keyword>Upgraded</keyword>. ', 'Flavor': '"What a marvelous discovery! This appears to be the inert egg of some magical creature. Who or what created this?" - Ranwid'},
    'Frozen Egg': {'Name': 'Frozen Egg', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Whenever you add a <power>Power</power> card to your deck, it is <keyword>Upgraded</keyword>. ', 'Flavor': 'The egg lies inert and frozen, never to hatch'},
    ...
    'Kunai': {'Name': 'Kunai', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Every time you play 3 <attack>Attacks</attack> in a single turn, gain 1 <buff>Dexterity</buff>.', 'Flavor': 'A blade favored by assasins for its lethality at range.'},
    'Letter Opener': {'Name': 'Letter Opener', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Every time you play 3 <skill>Skills</skill> in a single turn, deal 5 damage to ALL enemies.', 'Flavor': 'Unnaturally sharp.'},
    ...
    'Mummified Hand': {'Name': 'Mummified Hand', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Whenever you play a <power>Power</power> card, a random card in your hand costs 0 that turn.', 'Flavor': 'Frequently twitches, especially when your pulse is high.'},
    'Ornamental Fan': {'Name': 'Ornamental Fan', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Every time you play 3 <attack>Attacks</attack> in a single turn, gain 4 <keyword>Block</keyword>.', 'Flavor': 'The fan seems to extend and harden as blood is spilled.'},
    ...
    'Shuriken': {'Name': 'Shuriken', 'Class': 'Any', 'Rarity': 'Uncommon', 'Info': 'Every time you play 3 <attack>Attacks</attack> in a single turn, gain 1 <buff>Strength</buff>.', 'Flavor': 'Lightweight throwing weapons. Recommend going for the eyes.'},
    ...
    'Duality': {'Name': 'Duality', 'Class': 'Watcher', 'Rarity': 'Uncommon', 'Info': 'Whenever you play an <attack>Attack</attack>, gain 1 <buff>Dexterity</buff>.', 'Flavor': '“And the sun was extinguished forever, as if curtains fell before it.” - Zoroth'},
    ...
    # Rare relics
    'Bird-Faced Urn': {'Name': 'Bird-Faced Urn', 'Class': 'Any', 'Rarity': 'Rare', 'Info': 'Whenever you play a <power>Power</power> card, heal 2 HP.', 'Flavor': 'The urn shows the crow god Mazaleth looking mischievous.'},
    ...
    'Du-Vu Doll': {'Name': 'Du-Vu Doll', 'Class': 'Any', 'Rarity': 'Rare', 'Info': 'For each <curse>Curse</curse> in your deck, start each comabt with 1 additional <buff>Strength</buff>.', 'Flavor': 'A doll devised to gain strength from malicious energy.'},
    ...
    'Orange Pellets': {'Name': 'Orange Pellets', 'Class': 'Any', 'Rarity': 'Shop', 'Info': 'Whenever you play a <power>Power</power>, <attack>Attack</attack>, and <skill>Skill</skill> in the same turn, remove ALL of your debuffs.', 'Flavor': 'Made from various fungi found throughout the Spire, they will stave off any affliction.'},
    ...
    'Calling Bell': {'Name': 'Calling Bell', 'Class': 'Any', 'Rarity': 'Boss', 'Info': 'Obtain a special <curse>Curse</curse> and 3 relics.', 'Flavor': 'The dark iron bell rang 3 times when you found it, but now it remains silent.'},
    ...
    'Cursed Key': {'Name': 'Cursed Key', 'Class': 'Any', 'Rarity': 'Boss', 'Info': 'Gain 1 <keyword>Energy</keyword> at the start of each turn. Whenever you open a non-boss chest, obtain 1 <curse>Curse</curse>.', 'Flavor': 'You can feel the malicious energy emanating from the key. Power comes at a price.'},
    ...
    'Enchiridion': {'Name': 'Enchiridion', 'Class': 'Any', 'Rarity': 'Event', 'Source': 'Cursed Tome', 'Info': 'At the start of each combat, add a random <power>Power</power> card to your hand. It costs 0 until the end of your turn.', 'Flavor': 'The legendary journal of an ancient lich.'},
    ...
    'Necronomicon': {'Name': 'Necronomicon', 'Class': 'Any', 'Rarity': 'Event', 'Source': 'Necronomicon', 'Info': 'The first <attack>Attack</attack> played each turn that has a cost of 2 or more is played twice.', 
...
cards = {
    ...
    'Defend': {'Name': 'Defend', 'Block': 5, 'Energy': 1, 'Target': 'Yourself', 'Rarity': 'Basic', 'Type': 'Skill', 'Class': 'Ironclad', 'Info': 'Gain ꫱5 <keyword>Block</keyword>.', 'Effects+': {'Block': 8, 'Info': 'Gain ꫱8 <keyword>Block</keyword>'}, 'Function': use_defend},
    ...
    'Iron Wave': {'Name': 'Iron Wave', 'Damage': 5, 'Block': 5, 'Energy': 1, 'Target': 'Single', 'Rarity': 'Common', 'Type': 'Attack', 'Class': 'Ironclad', 'Info': 'Gain ꫱5 <keyword>Block</keyword>. Deal Σ5 damage.', 'Effects+': {'Damage': 7, 'Block': 7, 'Info': 'Gain ꫱7 <keyword>Block</keyword>. Deal Σ7 damage.'}, 'Function': use_ironwave},
    ...
    'Dual Wield': {'Name': 'Dual Wield', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Skill', 'Target': 'Yourself', 'Copies': 1, 'Energy': 1, 'Info': 'Create a copy of an <attack>Attack</attack> or <power>Power</power> card in your hand.', 
    ...
    'Fire Breathing': {'Name': 'Fire Breathing', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Power', 'Target': 'Yourself', 'Fire Breathing': 6, 'Energy': 1, 'Info': 'Whenever you draw a <status>Status</status> or <curse>Curse</curse>, deal 6 damage to ALL enemies.', 
                       'Effects+': {'Fire Breathing': 10, 'Info': 'Whenever you draw a <status>Status</status> or <curse>Curse</curse> card, deal 10 damage to ALL enemies.'}, 'Function': use_firebreathing},
    ...
    'Infernal Blade': {'Name': 'Infernal Blade', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Skill', 'Target': 'Yourself', 'Energy': 1, 'Info': 'Add a random <attack>Attack</attack> into your hand. It costs 0 this turn. <keyword>Exhaust.</keyword>', 'Effects+': {'Energy': 0}, 'Function': use_infernalblade},
    ...
    'Second Wind': {'Name': 'Second Wind', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Skill', 'Target': 'Yourself', 'Block Per Card': 5, 'Energy': 1, 'Info': '<keyword>Exhaust</keyword> all non-<attack>Attack</attack> cards in your hand and gain 5 <keyword>Block</keyword> for each card <keyword>Exhausted</keyword>.',
    ...
    'Sever Soul': {'Name': 'Sever Soul', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Attack', 'Target': 'Single', 'Damage': 16, 'Energy': 2, 'Info': '<keyword>Exhaust</keyword> all non-<attack>Attack</attack> cards in your hand. Deal Σ16 damage.', 
    ...
    'Uppercut': {'Name': 'Uppercut', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Attack', 'Target': 'Single', 'Weak/Vulnerable': 1, 'Energy': 2, 'Info': 'Deal Σ13 damage. Apply 1 <debuff>Weak</debuff>. Apply 1 <debuff>Vulnerable</debuff>.', 
    ...
    'Whirlwind': {'Name': 'Whirlwind', 'Class': 'Ironclad', 'Rarity': 'Uncommon', 'Type': 'Attack', 'Target': 'Area', 'Damage': 5, 'Energy': 'player.energy', 'Info': 'Deal Σ5 damage X times.', 'Effects+': {'Damage': 8, 'Info': 'Deal Σ8 damage X times.'}, 'Function': use_whirlwind},
    ...
    'Corruption': {'Name': 'Corruption', 'Class': 'Ironclad', 'Rarity': 'Rare', 'Type': 'Power', 'Target': 'Yourself', 'Energy': 3, 'Info': '<skill>Skills</skill> cost 0. Whenever you play a <skill>Skill</skill>, <keyword>Exhaust</keyword> it.', 'Effects+': {'Energy': 2}, 'Function': use_corruption},
    ...
    'Double Tap': {'Name': 'Double Tap', 'Class': 'Ironclad', 'Rarity': 'Rare', 'Type': 'Skill', 'Target': 'Yourself', 'Charges': 1, 'Energy': 1, 'Info': 'This turn, your next <attack>Attack</attack> is played twice.', 'Effects+': {'Charges': 2, 'Info': 'This turn, your next 2 <attack>Attacks</attack> are played twice'}, 'Function': use_doubletap},
    ...
    'Reaper': {'Name': 'Reaper', 'Class': 'Ironclad', 'Rarity': 'Rare', 'Type': 'Attack', 'Target': 'Area', 'Exhaust': True, 'Damage': 4, 'Info': 'Deal 4 damage to ALL enemies. Heal HP equal to unblocked damage. <keyword>Exhaust</keyword>.', 
